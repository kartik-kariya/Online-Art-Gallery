...
$select = "select * from tbl_customer where customer_username = '" . $_SESSION['signin_username'] . "'";
...
<html>
    ...
    <body>
        ...
        <div>
            <div style="margin-top: 7.5em;">
                ...
                <div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
                    ...
                    <div class="w3-row">
                        <!-- Left Column -->
                        <?php include './collector_profile-left-column.php'; ?>
                        <!-- Middle Column -->
                        <div class="w3-col m9">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7" style="text-align: left;">
                                                                <input type="text" name="firstname" value="<?php echo $r['customer_firstname'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;"/>
                                                                <br/>
                                                                <br/>
                                                                <input type="text" name="lastname" value="<?php echo $r['customer_lastname'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;"/>
                                                                <br/>
                                                                <br/>
                                                                <input type="text" name="username" value="<?php echo $r['customer_username'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;" readonly="true"/>
                                                                <br/>
                                                                <br/>
                                                                <input type="password" name="password" value="<?php $password = $r['customer_password'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;"/>
                                                                <br/>
                                                                <br/>
                                                                ...
                                                                <br/>
                                                                <br/>
                                                                <input type="text" name="email" value="<?php echo $r['customer_emailid'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;"/>
                                                                <br/>
                                                                <br/>
                                                                <input type="text" name="contactnumber" value="<?php echo $r['customer_contactnumber'] ?>" 
                                                                       class="w3-border w3-padding" style="width: 100%;"/>
                                                            </div>
                                                        </div>
                                                        <hr/>
        ...
        if (isset($_POST['btn_save'])) {
            ...
            if ($err == 0) {
                $update = "update tbl_customer set customer_firstname = '$firstname' , customer_lastname = '$lastname',"
                        . "customer_password = '$password' , customer_emailid = '$email' , customer_contactnumber = '$contact_number'"
                        . "where customer_username = '" . $_SESSION['signin_username'] . "'";
                if (mysqli_query($connection, $update)) {
                    echo "<script>swal('Done.!', 'Details Update Successfully .!', 'success');</script>";
                    header("Location: collector_profile-account_info.php");
                } else {
