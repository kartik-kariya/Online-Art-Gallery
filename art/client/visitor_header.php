...
<div id="page_wrapper">
    ...
    <ul class="cg__resMenu">
        ...
        <li><a class="active" href="visitor_home.php"><span>Home</span></a></li>
        <li><a href="visitor_artsgallery.php"><span>Gallery</span></a>
        <li><a href="visitor_artists.php"><span>Artists</span></a>
        <li><a href="visitor_shop.php"><span>Shop</span></a></li>
        <!--<li><a href=""><span>Auction</span></a></li>-->
        <li><a href="signin.php"><span>SignIn  / SignUp</span></a></li>
    </ul>
    <!-- Responsive menu end -->
                        ...
                        <div id="logo-container" class="logo-container">
                            <h1 class="site-logo logo " id="logo">
                                <a href="visitor_home.php" class="site-logo-anch">
                                         <!--<img class="logo-img site-logo-img" src="arts_files/images/logo3.jpg" width="50" height="50" alt="Vision">--> 
                                </a>
                            </h1>
                        </div>
                    </div>
                            ...
                            <div class="sh-component menu-wrapper">
                                ...
                                <div class="cg__menuWrapper">
                                    <div class="cg__mainMenu-trigger">
                                        <a href="visitor_home.php" class="cg__menuBurger">
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                        </a>
                                    ...
                                    <ul class="cg__mainMenu clearfix">
                                        ...
                                        <li><a href="visitor_shop.php"><span>Shop</span></a></li>
                                        <!--<li><a href=""><span>Auction</span></a></li>-->
                                        <li><a href="signin.php" name="link_sigin"><span>SignIn  / SignUp</span></a></li>
