...
<div id="page_wrapper">
    ...
    <ul class="cg__resMenu">
        ...
        <li><a href="collector_artsgallery.php"><span>Arts</span></a>
        ...
        <li><a href= "collector_profile-account_info.php"><span>Profile</span></a></li>
                        ...
                        <div id="logo-container" class="logo-container">
                            <h1 class="site-logo logo " id="logo">
                                <a href="collector_home.php" class="site-logo-anch">
                                    <img class="logo-img site-logo-img" src="arts_files/images/logo3.jpg" width="80" height="80" alt="Vision" title="Agency"> 
                                    <span style="font-size: 40px;color: #755588">Vision Arts</span>
                                </a>
                            </h1>
                        </div>
                    </div>
    ...
    <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="agency-slider" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.5.1">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-1" data-transition="slidevertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="arts_files/Home/slide01.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="arts_files/Home/slide01.jpg"  alt=""  data-lazyload="arts_files/Home/slide01.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <!--						<div class="tp-caption  "
                                                                            ...
                                                                            style="z-index: 5; white-space: nowrap; font-size: 65px; line-height: 120px; font-weight: 700; color: rgba(255,255,255,1);font-family:Montserrat;">Moment Photo Studio </div>
                    
                                                                     LAYER NR. 2 
                                                                    <a class="tp-caption CreativeFrontPage-Btn rev-btn "
                                                     href="login.php" target="_self"			 id="slide-1-layer-3"
                                                                             data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                                                            ...
                                                                            style="z-index: 6; white-space: nowrap; line-height: 56px; font-weight: 700; color: rgba(255,255,255,1);font-family:Montserrat;background-color:transparent;border-color:rgba(255,255,255,1);border-width:2px 2px 2px 2px;border-radius:0px 0px 0px 0px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;-webkit-transition:all .25s;transition:all .25s;cursor:pointer;text-decoration: none;">Login/Register </a>
                                                            </li>
                                                             SLIDE  
                                                    ...
                                                    Moment </div>
                                                                     ...
                                                                     LAYER NR. 4 
                                                                    <a class="tp-caption CreativeFrontPage-Btn rev-btn "
                                                                       href="login.php" target="_self"			 id="slide-2-layer-3"
                                                                             data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                                                             data-y="['middle','middle','middle','middle']" data-voffset="['87','63','65','52']"
                                                                                                    data-width="none"
                                                                            data-height="none"
                                                                            data-whitespace="nowrap"
