...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <!--titleblock section-->
        <section class="photobooth_grid_gallery photobooth_masonry_gallery" style="margin-top: 8%; margin-bottom: 2%;">
        <hr>
            <div class="row">
                <div class="col col-12   photobooth_content">
                    <h1 style="font-size:80px; font-family: serif; color: #542c6b;">Gallery</h1> 
                    <hr>
