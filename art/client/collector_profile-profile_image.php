                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST['btn_save'])) {
                                                    if (!empty($_FILES['profile_image']['name'])) {
                                                        $userdir = "";
                                                        $userdir = "./arts_files/Customer/" . $_SESSION['signin_username'] . "/";
                                                        if (!is_dir($userdir)) {
                                                            mkdir($userdir);
                                                        }
                                                        $imgdir = "";
                                                        ...
                                                        if (isset($_POST["btn_save"])) {
                                                            ...
                                                            // if everything is ok, try to upload file
                                                                ...
                                                                if (move_uploaded_file($_FILES["profile_image"]["tmp_name"], $target_file)) {
                                                                    ...
                                                                    $q = "update tbl_customer set customer_profileimage = '$profileimg' where customer_username = '".$_SESSION['signin_username']."'";
                                                                    if(mysqli_query($connection , $q)){
                                                                        //echo "<script>swal('Good Job.!', 'Profile Image Update Successfully .!', 'success');</script>";
                                                                        header("Location: collector_profile-profile_image.php");                                                                        
                                                                    } else {
