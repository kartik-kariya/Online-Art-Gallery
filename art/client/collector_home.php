...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <?php include('./collector_homeheader.php'); ?>
        </section>
...
-->
        <div class="txt-center" style="margin: 0;padding:0;">
            <a href="collector_artsgallery.php" class="ag_btn btn btn-lg btn-lined lined-dark btn--square call-to-action--btn ">Visit Gallery</a>
        </div>
    ...
    <section class="sidermargins pb-100 pt-100 color-overlay--dark" style="padding:2%;">
        <div class="container large-container">
            <div class="row">
                <?php include './collector_homeshop.php' ?>
            </div><!--end row of icons-->
            <br/>
            <center>
                <a href="collector_shop.php" class="ag_btn btn btn-lg btn-lined lined-light btn--square call-to-action--btn ">Visit Shop</a>
            </center>
        </div><!--end container-->
    </section>
...
<a href="collector_home.php" class="totop">TOP</a> <!--/.totop -->
