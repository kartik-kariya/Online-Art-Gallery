...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <?php include('./artist_homeheader.php'); ?>
        </section>
        ...
        <?php include './homegallery.php'; ?>
            ...
            <!--        <div class="container large-container large-container_grid">
                        <div class="grid ag-gridGallery-jstrigger "'>
            ...
            <!--                <div class="portfolio-overlay">
                    ...
                    <div class="grid-item grid-item--width2 gallery-item">
                        <div class="grid-item-wrapper">
                            <a class="portfolio-link" href="images/h2.jpg"></a>
                            <div class="ag-gridGallery__img-container">
                                <img src="images/h2.jpg" alt title="portfolio1" style="background-size: auto" >
                            </div>
                            <div class="portfolio-overlay">
                                <div class="portfolio-inner">
                                    <i class="ag-icon glyphicon glyphicon-picture ag-icon__circled-icon"></i>
...
-->
        <div class="txt-center" style="margin: 0;padding:0;">
            <a href="artist_artsgallery.php" class="ag_btn btn btn-lg btn-lined lined-dark btn--square call-to-action--btn ">Visit Gallery</a>
        </div>
    ...
    <section class="sidermargins pb-100 pt-100 color-overlay--dark" style="padding:2%;">
        <div class="container large-container">
            <div class="row">
                <?php include './artist_homeshop.php' ?>
            </div><!--end row of icons-->
            <br/>
            <center>
                <a href="artist_shop.php" class="ag_btn btn btn-lg btn-lined lined-light btn--square call-to-action--btn ">Visit Shop</a>
            </center>
        </div><!--end container-->
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="column-wrapper--right">
                        <div class="bl-quote ">
                            <a href="artist_uploadarts.php" class="ag_btn btn btn-lg btn-lined lined-dark btn--square call-to-action--btn ">Upload Artwork</a>
                        </div>
                    </div>
                </div>
            </div>
...
//                swal('Welcome', '<?php echo $uname ?>', 'success');
//            });
